        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DashboardPermission = table.Column<bool>(type: "bit", nullable: false),
                    BookingPermission = table.Column<bool>(type: "bit", nullable: false),
                    InvoicePermission = table.Column<bool>(type: "bit", nullable: false),
                    UserPermission = table.Column<bool>(type: "bit", nullable: false),
                    RoomPermission = table.Column<bool>(type: "bit", nullable: false),
                    ReportPermission = table.Column<bool>(type: "bit", nullable: false),
                    SettingPermission = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomAmenitys_Amenitys_AmenityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckedInByUserId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CheckedOutByUserId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
